...
namespace Turing.Business.Tests.Services
{
    public class UsersServiceTests : IDisposable
    {
        ...
        [Theory]
        [CustomAutoData]
        public async Task Login_ShouldReturnJwt_ByDefault(CredentialsModel model, User expectedUser, string expectedJwt)
        {
            // Arrange
        ...
        [Theory]
        [CustomAutoData]
        public async Task Register_ShouldRegisterUser_ByDefault(
        ...
        [Theory]
        [CustomAutoData]
        public async Task Register_ShouldReturnValidationErrors_ByDefault(
            RegisterUserModel model,
            User userToRegister,
